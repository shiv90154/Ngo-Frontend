      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-full bg-[#FF9933]/10 flex items-center justify-center">
            <Briefcase className="text-[#FF9933]" size={20} />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-800">IT Services Dashboard</h1>
            <p className="text-sm text-gray-500">Manage clients, projects, invoices & service requests</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <button onClick={() => router.push('/it/clients/new')} className="px-4 py-2 bg-[#FF9933] text-white rounded-lg hover:bg-[#ff8800]">Add Client</button>
            <button onClick={() => router.push('/it/projects/new')} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Project</button>
            <button onClick={() => router.push('/it/invoices/new')} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Generate Invoice</button>
            <button onClick={() => router.push('/it/service-requests/new')} className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">New Service Request</button>
          </div>
        </div>
      </div>
    </div>
