...
import NotificationBell from "@/components/NotificationBell";   // 🆕 real notification
...
export default function HealthcareNavbar() {
  ...
  // Mobile navigation items (full list)
  const mobileNavItems = [
    { name: "Dashboard", href: dashboardHref, icon: Heart },
    { name: "Find Doctors", href: "/healthcare/doctors", icon: User },
    { name: "Appointments", href: "/healthcare/appointments", icon: User },
    { name: "Health Records", href: "/healthcare/records", icon: User },
    { name: "Prescriptions", href: "/healthcare/prescriptions", icon: User },
  ];
