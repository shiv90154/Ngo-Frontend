  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center ">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        {/* Left Panel – hidden on mobile, visible on tablet/desktop */}
        <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-blue-900 to-blue-800 p-8 text-white flex flex-col justify-between">
          <div>
            ...
            <div className="border-l-4 border-orange-400 pl-4 mt-8">
          ...
          <div className="max-w-sm mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-700 hover:bg-blue-800 text-white font-medium py-2.5 rounded-lg transition shadow-md hover:shadow-lg disabled:opacity-50"
              >
                {loading ? (
